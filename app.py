...
H = {
    ...
    "hromada_parent": "Hromada of Parent PHCF",
    "settlement_parent": "Settlement of Parent PHCF",
    "phcf_name": "Name of PHCF",
    "sdp_name": "Name of SDP",
...
if not asset_uid:
    st.error("Missing asset UID for the selected form. Check config/secrets.")
    st.stop()
if not submit_url:
    st.error("Missing submit URL for the selected form. Check config/secrets.")
    st.stop()
if not api_key:
